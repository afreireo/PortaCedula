<img width="128" height="128" alt="ic_launcher-playstore" src="https://github.com/user-attachments/assets/e2be87a1-4119-42e2-bff7-4a73e758de10" />
...
* Visualización mediante modelo 3D interactivo y vista plana.
* Escáner automático de documentos con detección de bordes.
* Soporte para múltiples tarjetas.
* Generación y exportación de documentos en formato PDF.
...
<img width="360" alt="4pdf" src="https://github.com/user-attachments/assets/63382d84-c249-4030-b056-d89a02f5ee82" />


## Requisitos

* Android 10 (API 29) o superior.
* Conectividad para descarga de modelos de escaneo (inicial).
